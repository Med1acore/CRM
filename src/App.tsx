...
const PeopleHubPage = lazy(() => import('./features/people/PeopleHubPage').then(m => ({ default: m.PeopleHubPage })))
const GroupsHub = lazy(() => import('./pages/GroupsHub'))
const Communications = lazy(() => import('./pages/Communications'))
const Analytics = lazy(() => import('./pages/Analytics'))
const Login = lazy(() => import('./pages/Login'))
const Test = lazy(() => import('./pages/Test'))
const TasksLobbyPage = lazy(() => import('./pages/TasksLobbyPage').then(m => ({ default: m.TasksLobbyPage })))
